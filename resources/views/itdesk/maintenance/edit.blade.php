                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            <li><a href="{{ route('maintenance.index') }} ">Maintenance List</a> <span class="bread-slash">/</span>
                                            </li>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="all-form-element-inner">
                                                <form action="{{ route('maintenance.update',$main->id) }}" method="POST" enctype="multipart/form-data" >
                                                    {{csrf_field()}}
