                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li><a title="New Project" href="{{ route('project.index') }}"><span class="mini-sub-pro">New Project</span></a></li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li><a title="New User" href="{{ route('user.index') }}"><span class="mini-sub-pro">New User</span></a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="logo-pro">
                        <a href="{{route('home')}}"><img class="main-logo" src="img/logo/logo.png" alt="" /></a>
                    </div>
                </div>
            </div>
        </div>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                        <li><a href="{{route('user.akun', Auth::user()->id )}}"><span class="edu-icon edu-home-admin author-log-ic"></span> Akun </a>
                                                        </li>
                                                        <li>
                                                            <a href="{{ route('logout') }}"
