                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            <li><a href="<?php echo e(route('user.index')); ?> ">User List</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">User Form</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                ...
                                                <form action="<?php echo e(route('user.update', $user->id)); ?>" method="POST" enctype="multipart/form-data" >
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="text" name="password" class="form-control" value="<?php echo e($user->passback); ?>" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <select class="form-control" name="level">
                                                                    <option value="<?php echo e($user->level); ?>">
                                                                        <?php if($user->level == 1): ?> Admin
                                                                        <?php elseif($user->level == 2): ?> Management
                                                                        <?php else: ?> User 
                                                                        <?php endif; ?> 
                                                                    </option>
