...
<head>
    ...
    <!-- meanmenu icon CSS
		============================================ -->
    <link rel="stylesheet" href="<?php echo e(asset('itdesk/css/meanmenu.min.css')); ?>">
    <!-- main CSS
		============================================ -->
    <link rel="stylesheet" href="<?php echo e(asset('itdesk/css/main.css')); ?>">
    <!-- educate icon CSS
		============================================ -->
    <link rel="stylesheet" href="<?php echo e(asset('itdesk/css/educate-custon-icon.css')); ?>">
    <!-- morrisjs CSS
		============================================ -->
    ...
    <!-- modals CSS
        ============================================ -->
    <link rel="stylesheet" href="<?php echo e(asset('itdesk/css/modals.css')); ?>">
    <!-- forms CSS
        ============================================ -->
...
<body>
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="<?php echo e(url('/')); ?>"><img class="main-logo" src="<?php echo e(asset('itdesk/img/logo/itdesk_LOGO.png')); ?>" alt="" /></a>
                <strong><a href="<?php echo e(url('/')); ?>"><img src="<?php echo e(asset('itdesk/img/logo/logosn_.png')); ?>" alt="" /></a></strong>
            </div>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li >
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Troubleshoot List" href="<?php echo e(route('problem.index')); ?>"><span class="mini-sub-pro">Troubleshoot List</span></a></li>
                                <li><a title="Role" href="<?php echo e(route('problem.create')); ?>"><span class="mini-sub-pro">New Troubleshoot</span></a></li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Setting Maintenance" href="<?php echo e(route('maintenance.index')); ?>"><span class="mini-sub-pro">Maintenance List </span></a></li>
                                <li><a title="Shift Pattern" href="<?php echo e(route('maintenance.create')); ?>"><span class="mini-sub-pro">New Maintenance</span></a></li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Project List" href="<?php echo e(route('project.index')); ?>"><span class="mini-sub-pro">Project List</span></a></li>
                                <li><a title="New Project" href="<?php echo e(route('project.create')); ?>"><span class="mini-sub-pro">New Project</span></a></li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="User List" href="<?php echo e(route('user.index')); ?>"><span class="mini-sub-pro">User List</span></a></li>
                                <li><a title="New User" href="<?php echo e(route('user.create')); ?>"><span class="mini-sub-pro">New User</span></a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="logo-pro">
                        <a href="<?php echo e(route('home')); ?>"><img class="main-logo" src="<?php echo e(asset('itdesk/img/logo/itdesk_LOGO.png')); ?>" alt="" /></a>
                    </div>
                </div>
            </div>
        </div>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item">
                                                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
															<img src="<?php echo e(asset('itdesk/img/product/pro4.jpg')); ?>" alt="" />
															<span class="admin-name"> <?php echo e(Auth::user()->fullname); ?></span>
															<i class="fa fa-angle-down edu-icon edu-down-arrow"></i>
														</a>
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                        <li><a href="<?php echo e(route('user.akun', Auth::user()->id )); ?>"><span class="edu-icon edu-home-admin author-log-ic"></span> Account </a>
                                                        </li>
                                                        <li>
                                                            <a href="<?php echo e(route('logout')); ?>"
                                                               onclick="event.preventDefault();
                                                                             document.getElementById('logout-form').submit();"><span class="edu-icon edu-home-admin author-log-ic"></span> <?php echo e(__('Logout')); ?>
                                                                        ...
                                                                        <ul class="notes-menu-list">
                                                                            ...
                                                                            <li>
                                                                                <a href="#">
                                                                                    <div class="notes-list-flow">
                                                                                        <div class="notes-img">
                                                                                            <img src="<?php echo e(asset('itdesk/img/contact/4.jpg')); ?> " alt="" />
                                                                                        </div>
                                                                                        <div class="notes-content">
                                                                                            <p> The point of using Lorem Ipsum is that it has a more-or-less normal.</p>
                                                                                            <span>Yesterday 2:45 pm</span>
    ...
    <!-- counterup JS
		============================================ -->
    <script src="<?php echo e(asset('itdesk/js/counterup/jquery.counterup.min.js')); ?>"></script>
    <script src="<?php echo e(asset('itdesk/js/counterup/waypoints.min.js')); ?>"></script>
    <script src="<?php echo e(asset('itdesk/js/counterup/counterup-active.js')); ?>"></script>
    <!-- mCustomScrollbar JS
		============================================ -->
    ...
    <!-- morrisjs JS
		============================================ -->
    <script src="<?php echo e(asset('itdesk/js/sparkline/jquery.sparkline.min.js')); ?>"></script>
    <script src="<?php echo e(asset('itdesk/js/sparkline/jquery.charts-sparkline.js')); ?>"></script>
    <script src="<?php echo e(asset('itdesk/js/sparkline/sparkline-active.js')); ?>"></script>
    <!-- calendar JS
		============================================ -->
    <script src="<?php echo e(asset('itdesk/js/calendar/moment.min.js')); ?>"></script>
    <script src="<?php echo e(asset('itdesk/js/calendar/fullcalendar.min.js')); ?>"></script>
    <script src="<?php echo e(asset('itdesk/js/calendar/fullcalendar-active.js')); ?>"></script>
    <!-- tab JS
        ============================================ -->
