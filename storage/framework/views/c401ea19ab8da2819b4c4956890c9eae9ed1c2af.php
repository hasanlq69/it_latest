                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            <li><a href="<?php echo e(route('maintenance.index')); ?> ">Maintenance List</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Maintenance Form</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="all-form-element-inner">
                                                <form action="<?php echo e(route('maintenance.update',$main->id)); ?>" method="POST" enctype="multipart/form-data" >
                                                                    ...
                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                        <div class="form-select-list">
                                                                            <select class="form-control" name="type">
                                                                                <option value="<?php echo e($main->type); ?>"><?php echo e($main->type); ?></option>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                        <select class="form-control" name="department" >
                                                                            <option value="<?php echo e($main->department); ?>"><?php echo e($main->department); ?></option>
